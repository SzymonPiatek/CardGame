from .cards_to_buy import cards_to_buy, each_card_to_buy
...
each_card = {**each_card_to_buy, **each_dark_arts_card, **each_villain_card, **each_card_for_heroes, **each_place_card}
